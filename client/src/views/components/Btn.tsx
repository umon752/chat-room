...
const Btn: React.FC<BtnProps> = ({ text, clickEvent, disabled }) => {
  return (
    <>
      <button type="button" className={`parent u-convex u-convex-btn u-inline-flex-center rounded-30 px-24 py-12 ${disabled ? 'pointer-events-none opacity-50' : ''}`} onClick={clickEvent}>
